...
public class EmployeeController {
	...
	@GetMapping("/pageNo")
	public Page<Employee> getEmpPagination(@RequestParam(defaultValue="0") int page, @RequestParam(defaultValue="2") int size){
		return empService.getEmpPagination(page, size);
	}
